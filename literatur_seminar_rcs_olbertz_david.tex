...
\begin{itemize}
    \item alles läuft über die Server des Messenger-Betreibers [keine Quelle]
\end{itemize}

Beispiel WhatsApp

\begin{itemize}
    \item 2009 gegründet \cite{watimeline}
    \item seit 2014 Teil von Meta Platforms Inc. \cite{watimeline}
    \item früher musste man noch ein Abo bezahlen, ist aber mittlerweile kostenlos nutzbar \cite{wakostenlos}
    \item Funktionen
          \begin{itemize}
              \item Ende-zu-Ende-Verschlüsselung \cite{waencryption}
              \item auf Nachrichten mit Emojis reagieren
              \item selbstlöschende Nachrichten
              \item Gruppenchats
              \item Medien verschicken
              \item Live-Standort verschicken
              \item Videoanruf
              \item Multi-Platform mit WhatsApp Web / WhatsApp Desktop
          \end{itemize}
          \cite{wafaq}
\end{itemize}
